...
W_l = noise_generation.system_noise_generator(d_X, N, R)
V_l = noise_generation.observation_noise_generator(d_Z, N, S)
K = np.array([[1.0], [1.0]])
convergence_study.conv_study(X0, A, C, N, dt, W_l, V_l, K, delta_K=1e-6, n=10)
