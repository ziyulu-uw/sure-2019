...
class phar_kin:
    ...
    def v(time):
        ...
        return phar_kin.vb + phar_kin.vB * (np.abs(time)<1)*4.8
    ...
    def pk_model(x, time):
        ...
        dS1_dt = -temp * S1 + phar_kin.v(time)
    ...
    def solveODE(Plot):
        ...
        sol = odeint(phar_kin.pk_model, [phar_kin.S1_0, phar_kin.S2_0, phar_kin.I_0], t)
