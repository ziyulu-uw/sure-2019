...
class insulin:
    ...
    p2, p3 = 0.022, 1.7e-5 # (unit: min^-1, min^-1 mU/l)
    SI = p3 / p2  # glucose effectiveness (unit: mU/l)

class cost:
    r = 5e-3      # coefficient in cost function