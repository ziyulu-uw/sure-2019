...
from FinteDiffApprox import FDA_control, FDA_param
from optimization import optimize_control, optimize_param
...
control_gain, cost_l, grad_l = optimize_control(init_cond, param_list, control_gain, Filter, total_noise, Gb, Ib, N_meas, T, T_list, N, meal_params,
                 which='Adam', alpha=1e-1, momentum=0, beta=0.9, n=n)
