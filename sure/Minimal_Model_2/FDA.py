...
def FDA_param(state_variable, init_cond, param_list, control_gain, Filter, total_noise, Gb, Ib, N_meas, T, T_list, N,
              meal_params):
    ...
    for i in range(len(param_list)):
        ...
        G_f, X_f, I_f, Ra_f, mf = generate_path_whole(init_cond, param_shift_f, control_gain, Filter, total_noise, Gb,
...
def FDA_control(state_variable, init_cond, param_list, control_gain, Filter, total_noise, Gb, Ib, N_meas, T, T_list, N,
                meal_params):
    G, X, I, Ra = state_variable
    ...
    for i in range(len(control_gain)):
        ...
        G_f, X_f, I_f, Ra_f, mf = generate_path_whole(init_cond, param_list, control_shift_f, Filter, total_noise, Gb,
                                                      Ib, N_meas, T, T_list, N, meal_params)
...
def FDA_filter(state_variable, init_cond, param_list, control_gain, Filter, total_noise, Gb, Ib, N_meas, T, T_list, N,
               meal_params):
    G, X, I, Ra = state_variable
    ...
    for i in range(len(Filter)):
        ...
        G_f, X_f, I_f, Ra_f, mf = generate_path_whole(init_cond, param_list, control_gain, filter_shift_f, total_noise,
