...
from sure.filter_control.initialization import *
from sure.filter_control import noise_generation
from sure.filter_control import wrappers
from sure.filter_control import convergence_study
from sure.filter_control import stability_check
from sure.filter_control import performance_test
...
result = wrappers.wrapper(X0, A, C, B, G, K, N, S, R, d_X, d_Z, d_U, r,
                                       n=500, s_l=[1, 5, 10, 20, 27], which='Adam', alpha=0.05, momentum=0)
if result is None:
